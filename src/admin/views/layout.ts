...
// ("Agentia admin"): Space Grotesk + JetBrains Mono, brutalist buttons, scan
    ...
    <div class="sb-brand" style="padding:20px 18px 16px;border-bottom:1px solid var(--line)">
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <div style="line-height:1.05">
          <div style="font-family:'Space Grotesk';font-weight:700;font-size:15px;letter-spacing:-.02em">Agentia</div>
  ...
  const body = `
    <div class="card" style="max-width:720px">
      <div style="border:1px solid var(--linelit);background:var(--panel);box-shadow:6px 6px 0 var(--linelit);padding:28px">
        ...
        <a href="mailto:consultoriarf83@gmail.com?subject=Subir%20a%20Pro" class="bigbtn"
          ...
          <i data-lucide="arrow-up-right" width="17" height="17"></i> Subir a Pro
        </a>
      </div>
    </div>`;
